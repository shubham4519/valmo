            ...
            <footer className='bg-[#092d5e] text-gray-400 font-roboto py-8'>
                <div className=' flex px-8 md:px-28 gap-8 py-8 flex-col md:flex-row'>
                    ...
                    <div className='items-center w-full md:w-[25%]'>
                        ...
                        <div className='text-[14px] break-words'>support@valmopartners.in <br/> hello@valmopartners.in
                        </div>
                    </div>
                ...
                <p className='px-8 md:px-28 py-4 text-[15px] leading-4 font-mono'>
                    Disclaimer: Any official communication for business related formalities will be sent by Valmo using our authorised official email addresses (@valmopartners.in
